...
export default function Cart() {
  ...
  let { getLoggedUserCart, removeItem, updateCountItem, clearCart } = useContext(cartContext);
      ...
      <>
        ...
        <div className="bg-main-light my-5 p-5">
          ...
          <div className="text-end my-2">
            {/* <button className="btn btn-outline-danger" onClick={{}}>clear All cart</button> */}
          </div>
