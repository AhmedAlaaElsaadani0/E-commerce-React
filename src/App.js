  ...
  const router = createBrowserRouter([
    {
      ...
      children: [
        ...
        { path: "products/:id", element:<ProtectedRouter><Products /></ProtectedRouter>},
        { path: "products/brand/:BrandId", element:<ProtectedRouter><Products /></ProtectedRouter>},
        { path: "products/category/:categoryId", element:<ProtectedRouter><Products /></ProtectedRouter>},
